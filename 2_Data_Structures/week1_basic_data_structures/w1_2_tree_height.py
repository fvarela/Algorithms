...
def model_good(n, parents, debug=True):
    ...
    def get_last_leaf_parent_index():
        q = []
        q.append(nodes[root])
    ...
    parent_index = get_last_leaf_parent_index()
    depth = 1
...
def model_dummy(n, parents, debug=True):
...
if __name__ == '__main__':
    ...
    sample_input_1= [5,[4,-1,4,1,1]]
    sample_output_1 = 3
    sample_1_text = ''
    sample_input_2= [5,[-1,0,4,0,3]]
    sample_output_2 = 4
    sample_2_text = ''
