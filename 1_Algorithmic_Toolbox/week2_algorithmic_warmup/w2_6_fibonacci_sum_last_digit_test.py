...
print(f"\n{Style.BRIGHT}Last Digit of the Sum of Fibonacci Numbers Algorithm.{Style.RESET_ALL}\n")
table_data = [['Task', 'Given an integer n, find the last digit of the sum F0 + F1, + ... + Fn.'],
