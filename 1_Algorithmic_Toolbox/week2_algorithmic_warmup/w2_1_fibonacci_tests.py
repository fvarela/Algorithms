...
def model_dummy(n):
    if (n <= 1):
        return n
    return model_dummy(n - 1) + model_dummy(n - 2)
...
if __name__ == '__main__':
    ...
    print(f"\n{Style.BRIGHT}Fibonacci number generation algorithm.{Style.RESET_ALL}\n")
    table_data = [['Task', 'Given an integer n, find the nth Fibonacci number Fn'],
                    ['Constraints', '0<=n<=45'],
    ...
    while True:
        ...
        while choice not in ('1','2','3','4','5','6'):
            ...
            print(f"{Style.BRIGHT}1{Style.RESET_ALL} Execute Sample tests")
            print(f"{Style.BRIGHT}2{Style.RESET_ALL} Execute Boundary tests")
            print(f"{Style.BRIGHT}3{Style.RESET_ALL} Execute Stress tests")
            ...
            print()
        if choice == '1':
            good_model_test(_input=[10], test_name="Sample")
        elif choice == '2':
            good_model_test(_input=[0,45], test_name="Boundary")
        elif choice == '3':
