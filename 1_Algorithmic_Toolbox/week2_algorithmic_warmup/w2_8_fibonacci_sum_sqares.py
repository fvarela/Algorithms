...
stress_tests_boundary = [[0,int(1e4)]]

print(f"\n{Style.BRIGHT}Last Digit of the Sum of Sqares of Fibonacci Numbers Algorithm.{Style.RESET_ALL}\n")
table_data = [['Task', 'Compute the last digit of F0^2 + F1^2, + ... + Fn^2.'],
                ['Constraints', f'{boundary_input[0][0]}<=n<={boundary_input[0][1]}'],
...
while True:
    ...
    if choice == '1':
        ...
        good_model_test(_input=[[0], [int(1e14)]], test_name="Boundary")
    elif choice == '3':
